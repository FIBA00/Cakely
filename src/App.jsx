...
function ScrollAndTitle() {
  ...
  useEffect(() => {
    ...
    const copy =
      locale === "am"
        ? {
            title: "Cakely — ለወቅትዎ ኬኮች",
            description: "ለማይረሱ ወቅቶች በእጅ የሚዘጋጁ የበዓል ኬኮች።",
          }
        : {
            title: "Cakely — Cakes for your moments",
            description:
              "Thoughtful celebration cakes made to order by independent bakery counters.",
          };
    const titles = {
      "/": copy.title,
      "/shop": locale === "am" ? "ኬኮች — Cakely" : "Shop cakes — Cakely",
      "/custom-cake":
        locale === "am" ? "ኬክዎን ይፍጠሩ — Cakely" : "Create your cake — Cakely",
      "/cart": locale === "am" ? "ቅርጫት — Cakely" : "Your cart — Cakely",
      "/checkout": locale === "am" ? "ክፍያ — Cakely" : "Checkout — Cakely",
      "/about": locale === "am" ? "የእኛ ኩሽና — Cakely" : "Our kitchen — Cakely",
      "/contact": locale === "am" ? "ያግኙን — Cakely" : "Contact — Cakely",
      "/policies": locale === "am" ? "መመሪያዎች — Cakely" : "Policies — Cakely",
      "/support": locale === "am" ? "ድጋፍ — Cakely" : "Support — Cakely",
    };
        ...
        <Routes>
          ...
          <Route element={<RequireAdmin />}>
            <Route path="/admin" element={<AdminLayout />}>
              ...
              <Route
                path="categories"
                element={<AdminGeneric title="Categories" />}
              />
